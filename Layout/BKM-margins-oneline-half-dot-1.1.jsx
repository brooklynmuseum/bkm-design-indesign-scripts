function BKM_margins_stacked_half_dot() {
    ...
    var desiredLogoRatio = 0.9283875; // Adjusted ratio for 22.2813" logo on a 24" page
    ...
    // Set interior guides at 11.63% of the page width from the left and right
    var leftGuidePosition = pageWidth * 0.1163;
    var rightGuidePosition = pageWidth - (pageWidth * 0.1163);
