function BKM_margins_stacked_half_dot() {
    ...
    var desiredLogoRatio = 0.79568; // Desired ratio of logo width to page width
    ...
    var leftGuidePosition = pageWidth * 0.2162;
    var rightGuidePosition = pageWidth - (pageWidth * 0.2162);
